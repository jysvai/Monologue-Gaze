  ...
  MG.registerCase({
      ...
      { id: 'bevis', type: 'photo', name: '증거물 사진', skin: 'photo', need: ['k_garderobe'], desc: '감식반이 찍은 증거물 사진. 눌러서 하나씩 살핀다.', empty: '아직 찍은 증거물 사진이 없다.',
        scenes: [
          { id: 'ph_bags', title: '증거물 11~12호 — 가방 두 개의 내용물', meta: '1969.10.23 · 감식반 · 탁자에 펼쳐 위에서 촬영', art: 'bags_table',
            ...
            spots: [
              { id: 'sp_wigs', x: 11.5, y: 43, r: 9, label: '가발', keys: ['k_wigs'], body: ['[[가발]] 셋 — 검은 단발, 밤색 긴 머리, 회색이 섞인 틀어 올린 머리. 셋 다 안쪽에 머리핀이 꽂힌 채다.'] },
              { id: 'sp_glasses', x: 29.5, y: 41, r: 7, label: '안경', body: ['뿔테 하나, 금속테 하나. 알에 도수가 없다 — 그냥 유리.'] },
              { id: 'sp_binoc', x: 48.75, y: 41.5, r: 7, label: '쌍안경', keys: ['k_binoc'], body: ['8×30 [[쌍안경]]. 가죽끈이 닳았다. 초점이 먼 데에 맞춰진 채다.'] },
              { id: 'sp_camera', x: 68.5, y: 41, r: 7, label: '카메라', keys: ['k_film'], body: ['소형 35mm 카메라. 안에 끝까지 찍은 [[필름]] 한 통이 들어 있었다.'] },
              { id: 'sp_clothes', x: 88.5, y: 45, r: 8, label: '옷가지', body: ['블라우스, 치마, 스웨터. 목 뒤 상표 자리마다 가위로 오려 낸 자국.'] },
              { id: 'sp_notebook', x: 10.75, y: 71, r: 7, label: '작은 수첩', keys: ['k_notebook'], body: ['손바닥만 한 [[수첩]]. 앞쪽은 비었고, 맨 뒤 한 쪽에만 연필로 기호가 적혀 있다.'] },
              { id: 'sp_map', x: 29.5, y: 70, r: 7, label: '관광 지도', keys: ['k_map'], body: ['접힌 헬레순 [[관광 지도]] (1968년판). 펼친 면에 연필 자국.'] },
              { id: 'sp_key', x: 47.5, y: 68.5, r: 6, label: '열쇠고리', keys: ['k_bryggen'], body: ['놋쇠 열쇠고리. 새긴 글자: [[브뤼겐 호텔]] 407. 돌려주지 않았다.'] },
              { id: 'sp_soap', x: 64.5, y: 70, r: 6, label: '구겨진 종이', keys: ['k_fjordheim'], body: ['구겨진 호텔 비누 포장지. 인쇄된 이름: [[피오르헤임 호텔]].'] },
              { id: 'sp_box', x: 85, y: 70.5, r: 8, label: '빈 신발 상자', keys: ['k_randi'], body: ['빈 종이 상자. 가게 도장 찍힌 쪽은 찢겨 나갔지만, 안쪽에 붙은 가격표에 가게 이름이 남았다 — [[에이데 신발|k_randi]].'] },
              { id: 'sp_money', x: 17.5, y: 90.5, r: 7, label: '봉투 둘', body: [{ p: '돈을 지갑 없이 봉투 둘에 나눠 담았다. 노르웨이 크로네 1,340 · 서독 마르크 200 · 벨기에 프랑 500.', f: 'f_money' }] },
              { id: 'sp_ticket', x: 41.25, y: 90.5, r: 6, label: '기차표', body: [{ p: '10월 18일(토) 저녁 7시 40분 헬레순 → 오슬로 2등 기차표 한 장. 쓰지 않았다.', f: 'f_ticket' }] },
            ] },
        ] },
    ...
    art: {
      ...
      stern: { use: '현상한 필름 7번 — 새 페인트 밑 옛 글자 자국이 보이는 고물', ratio: '4:3',
        ...
        prompt: 'Close-up 35mm photograph of the stern of a rusty small cargo ship at a quay: freshly painted name letters on the dark hull, and beneath the new paint the faint raised outlines of older, different letters showing in low raking morning light. No letters legible. Water reflections, cool muted colours.' },

  ...
  MG.registerCase({
    ...
    art: {
      ...
      valley: { use: '신문 10월 20일자 — 크비트달 등산로', ratio: '4:3',
        ...
        redo: { level: '선택', why: '신문 사진인데 요즘 디지털 컬러 사진처럼 선명하게 나왔다 (망점·흑백 인쇄 느낌 없음).' } },
      ...
      stern: { use: '현상한 필름 7번 — 새 페인트 밑 옛 글자 자국이 보이는 고물', ratio: '4:3',
        ...
        redo: { level: '필수', why: '캡션은 「새 페인트 밑으로 다른 글자 자국이 도드라짐」인데 그림에 글자 흔적이 아예 없다. 이 사건의 핵심 단서다.' } },
      station: { use: '신문 10월 23일자 — 역 수하물 보관소 창구', ratio: '4:3',
        ...
        redo: { level: '선택', why: '신문 사진인데 깨끗한 컬러 사진으로 나왔다 (망점·흑백 인쇄 느낌 없음).' } },

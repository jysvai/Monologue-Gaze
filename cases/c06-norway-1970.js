...
(function () {
  ...
  MG.registerCase({
        ...
        scenes: [
          { id: 'ph_bags', title: '증거물 11~12호 — 가방 두 개의 내용물', meta: '1969.10.23 · 감식반 · 탁자에 펼쳐 위에서 촬영', art: 'bags_table',
            ...
            spots: [
              ...
              { id: 'sp_camera', x: 64, y: 36, r: 4.5, label: '카메라', keys: ['k_film'], body: ['소형 35mm 카메라. 안에 찍다 만 [[필름]] 한 통이 들어 있었다.'] },
    ...
    docs: {
      ...
      d_hyttebok: { src: 'arkiv', blood: false, find: ['k_hytte', 'k_per'], need: ['k_per'], title: '크비트달 산장 방명록', kicker: 'HYTTEBOK · KVITDALSHYTTA', meta: '헬레순 등산회 · 1969년 10월 · 옮겨 적음', body: [
    ...
    people: {
      p_kari: { name: '카리 바트네', role: '대학생 · 첫 발견자', where: '헬레순 대학 기숙사', key: 'k_kari', color: '#5b6e7a', initial: '카',
        ...
        ask: {
          ...
          k_per: ['옷에서 연기 냄새가 났어요. 그래서 경찰한테 그 사람 얘기를 한 거예요.', '들어오자마자 창가에 붙어서 계곡 쪽을 한참 내려다보더라고요. 저녁 내내 말이 없었고요.'],
      ...
      p_taxi: { name: '오드 헬레', role: '헬레순 택시 7호차 기사', where: '헬레순 역 앞 택시 승강장', key: 'k_taxi', color: '#4f5a48', initial: '오',
        ...
        ask: {
          ...
          k_brate: ['브라테 씨야 이 동네에서 모르는 사람이 없소. 내 차엔 한 번도 탄 적이 없지만.'],
      ...
      p_remmert: { name: '클라우스 렘메르트', role: '함부르크 기계 부품 판매원 · 브뤼겐 호텔 투숙객', where: '노르보그 경찰서 (전화 탐문)', key: 'k_remmert', color: '#5a5f78', initial: '렘',
        ...
        ask: {
          k_schlosser: { need: ['!f_dinner'], a: ['…식사를 한 번 했습니다. 15일에. 아내에겐 말하지 말아 주십시오.', '그 부인은 배 얘기만 했어요. 부두에 들어오는 배들이 어디서 오는지, 언제 칠을 새로 했는지. 저는 기계 부품쟁이라 모른다고 했죠.'], else: ['로비에서 인사 한 번 한 게 다라니까요.'] },
          k_woman: ['신문 보고 놀랐습니다. 정말입니다.'],
          k_1018: { need: ['!f_rental'], a: ['…17일 밤 열 시 [[연안선]]을 탔습니다. 20일에 노르보그에서 내렸고요. 사무장이 승선 명부를 갖고 있을 겁니다.'], else: ['18일요? 그 전날 헬레순을 떠났습니다. 그 뒤 일까지 말씀드려야 합니까?'] },
          k_bryggen: ['브뤼겐에는 출장 때마다 묵어요. 305호가 제 방이나 다름없죠.'],
          k_brate: ['브라테? 모르는 이름입니다.'],
          k_havorn: ['배 이름은 몰라요. 저는 기계만 팝니다.'],
          k_rental: { need: ['!f_rental'], a: ['…빌렸습니다. 회색 아마존. 거래처가 시 밖에 있어서요. 15일 아침부터 17일 저녁까지.', '17일 저녁 여덟 시 반에 돌려주고 곧장 부두로 가서 밤 열 시 [[연안선]]을 탔습니다. 배에서 내린 적 없어요. 사무장이 압니다.'], else: ['차요? 저는 기차와 배로만 다닙니다. 차는 빌린 적 없어요.'] },
          k_plate: { need: ['!f_rental'], a: ['제가 빌린 차도 HL-24로 시작했을 겁니다. 하지만 18일엔 제 손에 없었어요. 장부에 반납 시각이 있을 겁니다.'], else: ['번호판 같은 건 눈여겨보지 않습니다.'] },
    ...
    solution: {
      ...
      epilogue: [
        ...
        '16일 아침, 그녀는 오스트리아 골동품상 베라 슐로서라는 이름으로 24 318에 전화를 걸어 배를 빌리고 싶다고 했다. 그날 밤 앤트워프에는 "VT 봤음, 토요일에 확인"이라고 알렸다. 에이나르 브라테는 그 전화에서 옛 선장이 산다는 크비트달 위쪽 오두막까지 차로 데려다주겠다고 했고, 다음 날 두 번째 전화로 시각을 정했다.',

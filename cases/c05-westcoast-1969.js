  ...
  MG.registerCase({
    ...
    sources: [
      ...
      { id: 'cipher', type: 'cipher', name: '암호 해독지', need: ['k_cipher'], skin: 'cipher', title: '⧗ 암호문 — 5월 6일 도착분', meta: '편집국 번역부 해독지 · 1969년 5월',
        ...
        solved: [
          ...
          '번역부 메모: 원문 SUNDAYS 는 복수형. 편집국에서 나온 풀이는 제각각이다 — 교회 예배, 주말 나들이, 우리 [[일요일판]], 해안 도로의 일요일 드라이브. 정하지 못함.',
        ],
        ...
        sets: [
          { id: 'cmp_letters', title: '⧗ 편지 대조 — 같은 손인가', meta: '주 법무부 감식과 · 1969년 8월 22일 의뢰',
            intro: [
              ...
              '기준은 둘. 편지 (1)과 (2) — 수사과가 처음부터 한 사람의 것으로 묶어 둔 두 통이다. 나머지 가운데 네 통이 끝까지 남았다. 감식과는 그 가운데 한 통만 같은 사람의 것으로 본다.',
            ],
            ...
            solved: [
              { p: '감식과 회신 — 편지 (4)는 (1)·(2)와 같은 사람이 쓴 것으로 봄. 첫 줄, 접은 자국, 거꾸로 붙인 우표가 모두 맞음. 나머지 셋은 이 셋 가운데 하나 이상이 어긋남.', f: 'f_same_hand' },
              ...
              '감식과 메모: 세 통 모두 편지지 한 장을 세 번 접고 다시 한 번 꺾어, 봉투 입구보다 두꺼운 채로 밀어 넣었다. 봉투 입구 양쪽 모서리가 셋 다 늘어나 있다.',
            ],
    ...
    docs: {
      ...
      r_trace: { src: 'kpd', need: ['k_trace'], skin: 'report', blood: false, title: '회선 추적 회신 — 5월 4일 새벽', meta: '카브릴로 전화회사 놀턴 교환국 → 놀턴 경찰서', body: [
        ...
        { rows: [['00:20', '경찰서 요청 접수. 통화 회선이 열린 채 유지됨'], ['00:29', '발신 회선 확인 — [[도크 스트리트]] 212, 주유소 옆 [[공중전화]] (KN 4-0917)'], ['00:39', '순찰차 도착. 수화기가 줄에 매달려 흔들리고 있었음. 주변에 사람 없음'], ['비고', '순찰차 기록 — 길 건너편 창고 하역장에 불이 켜져 있었음. 트럭 여러 대가 시동을 건 채 짐을 싣는 중']], head: ['시각', '내용'], f: { 1: 'f_trace', 3: 'f_trace' } },
      ...
      r_scene: { src: 'kpd', need: ['k_morris'], skin: 'report', blood: 'heavy', title: '현장 감식 기록 — 시더 크릭 트레일 주차장', kicker: 'KNOWLTON P.D. · 감식반 · 69-0503 · 번역본', meta: '1969년 5월 4일 00:43 순찰차 도착 · 02:10 ~ 06:30 감식 · 감식반 E. 토레스', body: [
        ...
        { note: '※ 00:43 순찰차 도착 때 레이 두건은 차 밖 자갈 위에 엎드려 있었음. 운전석 문은 열린 채. 앤 모리스는 조수석.' },
        { sign: '감식반 E. 토레스' },
      ] },
      ...
      r_typewriter: { src: 'kpd', need: ['k_typewriter'], skin: 'report', blood: false, title: '문서 감정 회신 — 5월 9일 도착 타자 편지', meta: '주 법무부 감식과 → 놀턴 경찰서 · 1969년 5월 16일', body: [
        { rows: [['활자', '엘리트체. 소문자 e 윗고리 파손, 대문자 T 왼쪽으로 기울어 찍힘'], ['대조', '쿠리어 독자 투고란 단골 투고자 [[월도 펠]]의 투고 편지 11통과 같은 파손 흔적'], ['첫 줄', '「쿠리어 편집자 귀하.」 다음 줄 「나는 모래시계다.」'], ['서명', '펜으로 그린 모래시계. 다른 편지의 모래시계와 비율이 다름']], head: ['항목', '결과'], f: { 1: 'f_typewriter' } },
        '펠은 타자기 제출을 거부함. 수사과는 수색 영장 청구를 검토 중.',
      ] },
      r_jail: { cls: 'typed', src: 'kpd', need: ['k_pell', 'k_jail'], skin: 'ledger', blood: false, title: '카운티 구치소 입출소 기록 — 월도 펠', meta: '카브릴로 카운티 보안관실 · 발췌', body: [
      ...
      r_coyle: { cls: 'typed', src: 'kpd', need: ['k_coyle', 'k_refinery'], skin: 'ledger', blood: false, title: '출근 카드 조회 — 미치 코일', meta: '[[베이쇼어 정유공장]] 인사과 회신 · 1968년 12월 20일', body: [
      ...
      q_0817: { src: 'haul', blood: false, title: '배차 대장 — 1969년 8월 17일 (일)', kicker: 'KNOWLTON COURIER · CIRCULATION · SUNDAY ROUTES', meta: '배송부 배차 대장 사본 · 오스굿 부장 떼어 줌', body: [
        ...
        { p: '바꿈 청: 브레넌 — 8월 15일 (금) 말로. 까닭 「북쪽 길이 한가하다」. 배송부장 서명.', f: 'f_swap' },
      ...
      r_timecard: { cls: 'typed', src: 'kpd', need: ['k_timecard'], skin: 'ledger', blood: false, title: '출근 카드 — 배송부 (5월 3일 토요일 밤)', meta: '놀턴 쿠리어 배송 창고 · 타각 기록 · 임의 제출', body: [
        ...
        '판 싣기는 00:30 시작.',
        { rows: [['5.10', '23:47', '00:02', '23:50', '23:31'], ['5.17', '23:55', '23:58', '23:48', '23:28'], ['5.24', '23:50', '00:04', '23:55', '23:30']], head: ['같은 달 다른 토요일', '델가도', '퀸', '브레넌', '월리스'] },
      ] },
    },
    people: {
      p_lowell: { name: '마거릿 로웰', role: '놀턴 쿠리어 시티 에디터', where: '쿠리어 편집국 3층', key: 'k_lowell', color: '#6a4a5a', initial: 'L',
        ...
        ask: {
          k_hourglass: ['첫 편지를 뜯었을 땐 장난인 줄 알았어요. 그런데 라디오 얘기를 읽은 경찰 얼굴이 굳더군요.', '그 뒤로 편집국에 제보 전화가 쏟아졌어요. 밤마다 [[경찰 무전 수신기]]를 켜 놓고 사는 독자가 이 동네에만 수백 명이거든요.'],
          ...
          k_misprint: ['노리스… 그건 우리 실수예요. 5일자 1면에서 틀렸고 7일자에 바로잡았어요. 유족한테 항의 전화를 받았죠.'],
      ...
      p_coyle: { name: '미치 코일', role: '루스 캘러핸의 옛 남자친구 (25) · 정유공장 야간조', where: '베이쇼어 정유공장 기숙사', key: 'k_coyle', color: '#5a6a4a', initial: 'C',
        ...
        ask: {
          k_dec14: ['(한참 망설인다) …그날 저녁에 루스네 집 앞에 갔었어요. 여덟 시 반쯤. 루스 방 불이 꺼져 있더군요. 대니얼이랑 나간 거겠죠.', '그러고 나서 [[베이쇼어 정유공장]] 야간조에 들어갔어요. 밤 10시부터 아침 6시까지. 출근 카드 보세요.'],
      ...
      p_osgood: { name: '버넌 오스굿', role: '놀턴 쿠리어 배송부장', where: '도크 스트리트 배송 창고 사무실', key: 'k_osgood', color: '#6a5a3a', initial: 'O',
        ...
        ask: {
          ...
          k_roster: ['배차 대장을 통째로는 못 내주오. 운전사들 품삯이 다 적힌 장부라. 어느 일요일인지 날짜를 대면 그 장만 떼어 주지.', '대장은 일요일 날짜로 적소. 토요일 밤에 싣는 판도 이튿날 일요일 날짜로.'],
          ...
          k_dawnbox: [{ p: '우체국 앞이라… 7번 트럭은 산타 레이나 우체국 앞 신문함에 새벽 두 시 사십 분쯤 판을 넣소. 밀브룩은 세 시 오십 분, 포트 헤일리는 다섯 시 사십 분. 세 곳 다 우체통이 신문함 바로 옆이지.', f: 'f_mailbox' }, '7번은 [[프랭크 델가도]] 노선이오. 그 친구는 그 길을 눈 감고도 도오.'],
      ...
      p_brennan: { name: '칼 브레넌', role: '놀턴 쿠리어 배송 트럭 운전사 (31)', where: '도크 스트리트 배송 창고', key: 'k_brennan', color: '#3f4f5f', initial: 'B',
        ...
        ask: {
          k_route7: { need: ['!f_roster7'], a: ['…몇 번 바꿔 탔소. 북쪽 길이 한가해서. 그게 무슨 상관이오.', '— 몇 번이나요? 어느 일요일에요?', '(대답하지 않는다. 안경을 벗어 천천히 닦는다.)'], else: ['7번? 그건 델가도 노선이오. 난 시내만 돈다니까.'] },
          ...
          k_sunday: [{ p: '일요일판은 새벽에 싣고 새벽에 내려놓소. 판매소 문 앞이며 신문함에. 해 뜨기 전에 다 끝내야 하지.', f: 'f_brennan_sunday' }],
          k_graylock: ['등대길? 북쪽으로 가려면 그 길밖에 없소.'],
          k_dawnbox: ['우체통? 시내엔 모퉁이마다 서 있소. 그게 배송부랑 무슨 상관이오.'],

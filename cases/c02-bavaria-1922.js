...
(function () {
  ...
  MG.registerCase({
    ...
    brief: {
      ...
      scrawl: '1월 26일과 2월 5일 사이, 열흘이 비어 있다.',
    },
    ...
    sources: [
      ...
      { id: 'skizze', type: 'photo', name: '현장 스케치', desc: '2월 6일 검증 때 군청 서기 포이히트가 연필로 그린 현장 스케치. 조서에 한 줄로 적힌 것도 그림에는 그대로 남아 있다. 그림을 눌러 살핀다.',
        scenes: [
          { id: 'sc_kueche', title: '스케치 1 — 부엌', meta: '1923.2.6 · 서기 포이히트 · 연필', art: 'sk_kitchen',
            ...
            spots: [
              { id: 'sp_herd', x: 22, y: 59, r: 9, label: '화덕 아궁이와 재받이', body: [{ p: '재받이에서 재가 넘쳐 바닥까지 흘렀다. 맨 위는 고운 흰 재, 그 밑으로 검은 숯 층과 흰 재 층이 번갈아 여러 겹. 옆 장작 궤짝은 바닥이 보인다.', f: 'f_smoke' }] },
              { id: 'sp_tisch', x: 54.5, y: 42, r: 6, label: '식탁 위 접힌 신문', body: [{ p: '네 겹으로 접힌 주보. 서기가 옆에 "제8호, 1.27."이라고 적어 두었다. 펼친 자국은 없다.', f: 'f_paper_taken' }] },
              ...
              { id: 'sp_napf', x: 87, y: 86, r: 7, label: '문간의 개 밥그릇', body: [{ p: '문간 바닥의 나무 밥그릇. 빵 껍질과 삶은 감자 찌꺼기가 두 켜로 말라붙었다. 개는 마당 기둥에 묶인 채 살아 있었다.', f: 'f_fed' }] },
            ] },
      ...
      { id: 'zeit', type: 'timeline', name: '열흘 재구성', need: ['k_milch', 'k_zeitung'], skin: 'board', title: '하젤외드의 열흘 — 1월 24일부터 2월 3일까지', meta: '초소 벽에 핀으로 꽂은 판',
        ...
        intro: ['카드마다 어느 기록에서 나왔는지 찾아 제 날짜 칸으로 옮긴다. 수거 장부, 집배 수첩, 가계 수첩, 대장간 장부, 마을 사람들의 말, 그리고 켈바흐 쪽 기록.', '칸마다 한 장. 날짜가 적히지 않은 카드는 기록을 찾아 날을 맞춘다.'],
        ...
        solved: [
          '아홉 장이 모두 제 칸에 꽂혔다. 1월 24일 아침부터 2월 3일 밤까지.',
          { p: '판 아래쪽 세 칸 — 1.29 (월) 아침: 주보 없어짐, 굴뚝 연기, 숲길 어귀의 흰 말 썰매. 1.29 (월) 저녁: 켈바흐 여관 숙박부에 장 손님 한 줄, 말과 썰매는 뒤 마구간. 2.3 (토) 밤: 소 울음.', f: 'f_tl_monday' },
        ],
    ...
    docs: {
      ...
      d_hausierer: { src: 'akten', blood: false, need: ['k_hausierer', 'k_weissach'], skin: 'telegram', title: 'TELEGRAMM · WEISSACH → OBERRÖDING', meta: '1923년 2월 9일 오전 10시 12분 접수', body: [
      ...
      d_scheune: { src: 'hof', blood: 'heavy', title: '검증 조서 — 헛간', kicker: 'AUGENSCHEIN · STADEL', meta: '1923년 2월 6일 · 켈바흐 군청 검증위원회', body: [
        ...
        '건초 더미 바로 옆으로 여물 부스러기가 외양간까지 길게 흘려져 있음. 부스러기는 여러 켜로 밟혀 짚 바닥에 다져졌음.',
      ] },
      ...
      d_arrest: { src: 'amt', blood: false, find: ['k_pfaenzl', 'k_kelbach'], need: ['!f_pfaenzl_claim'], title: '켈바흐 군청 유치장 장부', kicker: 'ARRESTBUCH · BEZIRKSAMT KELBACH', meta: '1923년 1월 20일 ~ 2월 1일', body: [
        { rows: [
          ...
          ['1.31 01:10', '가축 몰이꾼 둘', '장 첫날 밤 술 싸움', '1.31 10:00'],
      ...
      d_wb_0210: { src: 'blatt', blood: false, find: ['k_ghost', 'k_hausierer', 'k_pfaenzl'], title: '하젤외드를 둘러싼 소문 셋', kicker: '제12호 · 1923년 2월 10일 토요일', meta: '본보 기자', body: [
        ...
        { h: '둘, 방물장수' },
        '1월 24일 마을을 돈 [[방물장수|k_hausierer]] 하나가 잡화점과 여관에서 하젤외드 가는 길을 두 번이나 물었다는 말이 있다. 군청은 "이웃 [[바이사흐]] 초소에 물어 두었다"고만 답하였다.',
        { h: '셋, 쫓겨난 머슴' },
      ...
      d_wb_0127: { src: 'blatt', blood: false, find: ['k_zeitung'], title: '군내 소식', kicker: '제8호 · 1923년 1월 27일 토요일 · 한 부 150마르크', meta: '본보 · 군내 소식란', body: [
        { h: '큰눈' },
    ...
    people: {
      p_gerstl: { name: '마르틴 게르스틀', role: '오버뢰딩 우체국 집배원 · 첫 발견자', where: '오버뢰딩 우편 대리점', key: 'k_gerstl', color: '#4f5d6e', initial: '게',
        ...
        ask: {
          ...
          k_knauer: ['크나우어? 운터뢰딩 사람이오. 그쪽은 내 구역이 아니라 얼굴이나 아는 정도지.'],
          k_schlitten: [{ p: '썰매라면 1월 29일 월요일 아침에 하나 봤소. 하젤외드 뒤 [[태넨슐라크]] 숲길 어귀에 서 있더군. 흰 말이었고, 말 등에 담요를 덮어 놨소. 사람은 못 봤소.', f: 'f_sledge' }],
      ...
      p_hubmann: { name: '프란츠 후프만', role: '이웃 농부 · 우유 수거소 주인', where: '오버뢰딩 후프만 농가', key: 'k_hubmann', color: '#6b7a5a', initial: '후',
        ...
        ask: {
          ...
          k_stall: [{ p: '소는 사흘만 굶겨도 울어 대오. 그 집 소들은 2월 3일 밤에야 울기 시작했지.', f: 'f_fed' }],
      ...
      p_magdalena: { name: '마그달레나 뷔르츠', role: '하젤외드의 전 하녀 (1922년 11월까지)', where: '켈바흐 빵집', key: 'k_magdalena', color: '#9a6a5c', initial: '마',
        ...
        ask: {
          ...
          k_tannenschlag: ['11월에 밤늦게 그 숲 쪽에 불빛이 보였어요. 숲 가장자리에 나무꾼 오두막이 있거든요. 숲을 산 사람이 거기서 나무를 한다고 들었어요.', '그 숲 산 사람이 11월에 한 번 와서, 주인어른이랑 부엌에서 호밀 얘기로 언성을 높였어요. 저는 빵 반죽을 하느라 얼굴은 못 봤어요.'],
          k_knauer: ['그 이름은 처음 들어요. 저는 부엌일만 해서 장사꾼들은 잘 몰라요.'],
      ...
      p_rottmayr: { name: '카스파르 로트마이어', role: '오버뢰딩 대장장이', where: '오버뢰딩 성당 앞 대장간', key: 'k_rottmayr', color: '#5a4a3a', initial: '로',
        ...
        ask: {
          ...
          k_pfaenzl: ['펜츨? 12월에 쫓겨나던 날 여기 들러서 영감 욕을 한참 하고 갔소. 1월 말엔 통 못 봤고. [[켈바흐]]로 갔다던가.'],
      ...
      p_knauer: { name: '발렌틴 크나우어', role: '운터뢰딩 목재·가축상 · 태넨슐라크 숲 주인', where: '운터뢰딩 크나우어 집 마당', key: 'k_knauer', color: '#4a4f3a', initial: '크',
        intro: ['(소 고삐를 말뚝에 감는다) 크나우어요. 운터뢰딩에서 나무하고 소 장사를 하오. 모스바우어 영감 일은 들었소. 몹쓸 일이지.'],
        ask: {
          k_freitag: [{ p: '26일? 그날 오후에 켈바흐로 나가서 [[골데너 슈테른]]에 묵었소. 성촉절 장이 서니까. 목요일 장이 끝나고서야 돌아왔지.', f: 'f_knauer_claim' }],
          ...
          k_schlitten: ['짐썰매요. 장작이며 소를 실어 나르지. 장에 가려고 지난달에 로트마이어한테 날을 새로 달았소. 흰 말이야 레겐탈 장사꾼들도 끌고 다니고.'],
    ...
    solution: {
      culprit: 'k_knauer',
      claims: [
        { id: 'c1', q: '네 사람이 숨진 때를 가리키는 기록', accept: ['f_milk', 'f_unpacked', 'f_calendar'] },
        { id: 'c2', q: '네 사람이 숨진 뒤의 농가', accept: ['f_paper_taken', 'f_smoke', 'f_fed'] },
